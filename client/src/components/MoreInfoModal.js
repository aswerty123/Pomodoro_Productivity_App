...
const OverLay = (props) => {
  ...
  return (
    ...
    >
      <div className="bg-white shadow-gray-900 rounded-xl fixed top-[30vh] left-[10%] w-[80%] z-100 flex-wrap">
        ...
        <div class="max-w-screen-xl mx-auto px-2">
          <div class="px-2 py-2">
            <div class="w-full p-2">
              ...
              <div class="px-5 py-5 bg-white rounded-lg shadow-lg flex flex-row">
                <div className="text-gray-700 text-base m-2">
